...
import { LecturasPorAnio, LecturaDia, obtenerColorConsumoDia } from "./utils";
...
interface Props {
  ...
  eliminarBodega: (mes: number, dia: number, bodega: 1 | 2) => void;
  guardarEnergiaEnBD: (mes: number, dia: number, data: LecturaDia) => void;
}

export default function ConsumoEnergiaTabla({
  modoNoche,
  mesesARenderizar,
  meses,
  anioSeleccionado,
                  ...
                  <tbody>
                    ...
                    <tr>
                      {diasMes.map(({ dia, tipo }) => {
                        ...
                        const colorConsumo = obtenerColorConsumoDia(total, modoNoche);
