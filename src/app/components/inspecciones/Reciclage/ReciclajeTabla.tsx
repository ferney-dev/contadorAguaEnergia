...
export default function ReciclajeTabla({
  modoNoche,
  dataBackend,
  setDataBackend,
          ...
          >
            ...
            <div className={`mb-6 rounded-2xl p-5 border-2 ${
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      modoNoche ? "bg-blue-600/20" : "bg-blue-100"
                    }`}>
                ...
                <button
                  onClick={() =>
                    eliminarInspeccionGrupo(responsableGrupo, registros[0]?.fecha?.split("T")[0])
                  }
                      ...
                      >
                        ...
                        <td className={`p-3 border ${modoNoche ? "border-[#353535]" : "border-gray-200"}`}>
                          {editandoAreaId === area.id ? (
                            ...
                            <div className="space-y-2">
                              <div className="font-semibold text-center px-3 py-2">
                                {area.nombre || ""}
                              </div>
                              <div className="flex gap-2 justify-center">
                                <button
            ...
            >
              <div className={`p-4 border-b-2 ${modoNoche ? "border-[#444]" : "border-gray-300"}`}>
                ...
                <p className={`text-sm mt-1 ${modoNoche ? "text-gray-400" : "text-gray-500"}`}>
                  Totales por categoría de residuos
                </p>
              </div>
              <table className="w-full text-sm border-collapse">
                <thead>
