import { FACTOR_CONVERSION, UMBRAL_CONSUMO_ALTO } from "./constants";
...
export const obtenerColorConsumoAgua = (valor: number, modoNoche: boolean) => {
...
export const obtenerEstadoConsumo = (
  consumo: number,
  promedio: number
